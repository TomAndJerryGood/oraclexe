...
/*
데이터유형 
     VARCHAR2(SIZE) - 가변 길이 문자 데이터(최대 4000까지 가능)
...
/*
ALTER 문 
    데이터베이스 객체 구조다 속성을 변경할 때 사용되는 SQL 명령문입니다.
*/
...
--컬럼 수정하기
ALTER TABLE simple MODIFY(name VARCHAR2(39));

INSERT INTO simple VALUES(1,'RONALDO');
