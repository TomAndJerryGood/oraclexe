...
FROM employees;
-- null은 무슨 값을 더하거나 곱해도 null 이다
/*
열 alias 정의
    열(clone)머리글의 이름을 바꿉니다.
    열 이름 바로 뒤에 나옵니다. (열 이름과 alias 사이에 선택사항인 as 키워드가 올수있습니다.
...
-- as 생략 가능 
SELECT last_name name, commission_pct comm, salary * 10 as 급여10배
FROM employees;
-- 큰 따옴표로도 가능
